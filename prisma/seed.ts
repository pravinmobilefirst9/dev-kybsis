...
//       { name: 'surrender_value', type: 'number', label: 'Surrender Value', order_id: 4, mandatory: true },
//       { name: 'lifetime_income_value', type: 'number', label: 'Lifetime Income Value', order_id: 5, mandatory: true },
//       { name: 'interest_rate', type: 'number', label: 'Interest Rate', order_id: 6, mandatory: false },
//       { name: 'payment_frequency', type: 'text', label: 'Payment Frequency', order_id: 7, mandatory: false, options: ['Monthly', 'Quarterly', 'Annually'] },
//     ]
//   },
//   {
//     name: "Cash & Money Market",
//     fields: [
//       { name: 'market_value', type: 'number', label: 'Market Value', order_id: 1, mandatory: true },
//       { name: 'interest_rate', type: 'number', label: 'Interest Rate', order_id: 2, mandatory: false },
//       { name: 'institution', type: 'text', label: 'Institution', order_id: 3, mandatory: false },
//     ]
//   },
//   {
//     name: "Equity/ETF",
...
//       { name: 'market_price_(per_share)', type: 'number', label: 'Market Price (Per Share)', order_id: 4, mandatory: true },
//       { name: 'market_value', type: 'number', label: 'Market Value', order_id: 5, mandatory: true },
//       { name: 'dividend_yield', type: 'number', label: 'Dividend Yield', order_id: 6, mandatory: false },
//       { name: 'esg_rating', type: 'text', label: 'ESG Rating', order_id: 7, mandatory: false, options: ['Low', 'Medium', 'High'] },
//     ]
//   },
//   {
//     name: "Hedge Fund",
...
//       { name: 'name', type: 'text', label: 'Name', order_id: 1, mandatory: true },
//       { name: 'value', type: 'number', label: 'Value', order_id: 2, mandatory: true },
//       { name: 'strategy', type: 'text', label: 'Strategy', order_id: 3, mandatory: false },
//       { name: 'redemption_terms', type: 'text', label: 'Redemption Terms', order_id: 4, mandatory: false },
//     ]
//   },
//   {
//     name: "Life Insurance",
...
//       { name: 'policy', type: 'text', label: 'Policy', order_id: 1, mandatory: true },
//       { name: 'cash_value', type: 'number', label: 'Cash Value', order_id: 2, mandatory: true },
//       { name: 'premium', type: 'number', label: 'Premium', order_id: 3, mandatory: false },
//       { name: 'benefit_amount', type: 'number', label: 'Benefit Amount', order_id: 4, mandatory: false },
//     ]
//   },
//   {
//     name: "Mutual Fund",
...
//       { name: 'market_price', type: 'number', label: 'Market Price', order_id: 4, mandatory: true },
//       { name: 'market_value', type: 'number', label: 'Market Value', order_id: 5, mandatory: true },
//       { name: 'expense_ratio', type: 'number', label: 'Expense Ratio', order_id: 6, mandatory: false },
//       { name: 'fund_manager', type: 'text', label: 'Fund Manager', order_id: 7, mandatory: false },
//     ]
//   },
//   {
//     name: "Fixed Income",
...
//       { name: 'market_price', type: 'number', label: 'Market Price', order_id: 3, mandatory: true },
//       { name: 'market_value', type: 'number', label: 'Market Value', order_id: 4, mandatory: true },
//       { name: 'yield_to_maturity', type: 'number', label: 'Yield to Maturity', order_id: 5, mandatory: false },
//       { name: 'credit_rating', type: 'text', label: 'Credit Rating', order_id: 6, mandatory: false },
//     ]
//   },
//   {
//     name: "Private Equity",
...
//       { name: 'name', type: 'text', label: 'Name', order_id: 1, mandatory: true },
//       { name: 'value', type: 'number', label: 'Value', order_id: 2, mandatory: true },
//       { name: 'fund_lifecycle_stage', type: 'text', label: 'Fund Lifecycle Stage', order_id: 3, mandatory: false, options: ['Early', 'Mid', 'Late'] },
//       { name: 'capital_commitment', type: 'number', label: 'Capital Commitment', order_id: 4, mandatory: false },
//     ]
//   }
// ];
