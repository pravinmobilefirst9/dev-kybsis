...
-- CreateEnum
CREATE TYPE "CompoundFrequency" AS ENUM ('ANNUALLY', 'SEMIANNUALLY', 'QUARTERLY', 'MONTHLY', 'SEMIMONTHLY', 'BIWEEKLY', 'WEEKLY', 'DAILY', 'CONTINUOUSLY');

-- CreateEnum
CREATE TYPE "Timing" AS ENUM ('BEGINNING', 'END_OF_EACH_MONTH', 'END_OF_EACH_YEAR');
...
CREATE TABLE "Forecast" (
    ...
    "compound" "CompoundFrequency" NOT NULL,
    "contributeAt" "Timing" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Account" ADD CONSTRAINT "Account_plaid_item_id_fkey" FOREIGN KEY ("plaid_item_id") REFERENCES "PlaidItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Balance" ADD CONSTRAINT "Balance_account_tbl_id_fkey" FOREIGN KEY ("account_tbl_id") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;
